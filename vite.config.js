...
import { resolveSalesforceNamespaceShimsPlugin } from './vite-plugins/salesforce-namespace-shims.js';
...
export default defineConfig({
  ...
  plugins: [
    ...
    resolveSalesforceNamespaceShimsPlugin(),
    lwc({
      modules: [
        {
        ...
        {
          name: 'lightning/platformShowToastEvent',
          path: path.resolve('./src/build/shim/platformShowToastEvent.js'),
        },
        {
          name: 'lightning/uiRecordApi',
          path: path.resolve('./src/build/shim/uiRecordApi.js'),
        },
        {
          name: 'lightning/platformWorkspaceApi',
          path: path.resolve('./src/build/shim/platformWorkspaceApi.js'),
        },
        {
          name: 'force/navigation',
          path: path.resolve('./src/build/shim/forceNavigation.js'),
        },
        {
