...
**Do not add a page header row** — the dashboard content starts directly below the nav bar. (See [`docs/ui-patterns/page-header.md`](./page-header.md) "When to use a page header" for the full list of pages where headers are and aren't appropriate.)
